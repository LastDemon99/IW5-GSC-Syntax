...
setup_destructible_dots( var_0 )
{
    ...
    foreach ( var_3 in var_0 )
    {
        ...
        if ( isdefined( var_3._id_164F ) && issubstr( var_3._id_164F, "destructible_type" ) && issubstr( var_3._id_164F, self.destructible_type ) )
        {
...
setdot_ontick( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    self.ticks[var_8]._id_298D = var_3;
    self.ticks[var_8]._id_298B = var_4;
