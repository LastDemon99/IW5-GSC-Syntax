    ...
    if ( var_2 isitemunlocked( "specialty_coldblooded" ) && var_2 maps\mp\_utility::_hasperk( "specialty_coldblooded" ) )
    {
        ...
        else
        {
            ...
            foreach ( var_45 in level.players )
            {
                ...
                var_43 = var_43 + level.activeuavs[var_45.guid];
            }
...
buildchallegeinfo()
{
    ...
    var_0 = var_0 + buildchallengetableinfo( "mp/dailychallengesTable.csv", 1 );
    var_0 = var_0 + buildchallengetableinfo( "mp/weeklychallengesTable.csv", 2 );
