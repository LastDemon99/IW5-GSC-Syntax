...
spawndogtags( var_0, var_1 )
{
    ...
    {
        var_2[0] = spawn( "script_model", ( 0, 0, 0 ) );
        var_2[0] setmodel( "prop_dogtags_foe" );
        var_2[1] = spawn( "script_model", ( 0, 0, 0 ) );
        var_2[1] setmodel( "prop_dogtags_friend" );
        var_3 = spawn( "trigger_radius", ( 0, 0, 0 ), 0, 32, 32 );
        level.dogtags[var_0.guid] = maps\mp\gametypes\_gameobjects::createuseobject( "any", var_3, var_2, ( 0, 0, 16 ) );
...
onuse( var_0 )
{
    if ( var_0.pers["team"] == self.victimteam )
    {
        ...
        var_0 thread onpickup( var_1, var_2 );
    }
    else
    {
        ...
        if ( self.attacker != var_0 )
            self.attacker thread onpickup( var_1, var_2 );
...
clearonvictimdisconnect( var_0 )
{
    ...
    if ( isdefined( level.dogtags[var_1] ) )
    {
        ...
        if ( isdefined( level.dogtags[var_1].attacker ) )
            level.dogtags[var_1].attacker thread maps\mp\gametypes\_rank::xpeventpopup( &"SPLASHES_DENIED_KILL", ( 1, 0.5, 0.5 ) );
