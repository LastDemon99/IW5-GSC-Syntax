...
createteamflag( var_0, var_1 )
{
    ...
    else
    {
        ...
        var_5 = maps\mp\gametypes\_gameobjects::createcarryobject( var_0, var_2, var_3, ( 0, 0, 85 ) );
...
onpickup( var_0 )
{
    ...
    else
    {
        ...
        {
            level.capzones[var_1].trigger maps\mp\_entityheadicons::setheadicon( var_0, level.iconwaitforflag2d, ( 0, 0, 85 ), undefined, undefined, undefined, undefined, undefined, undefined, undefined, 0 );

            if ( isdefined( level.teamflags[var_1].carrier ) )
                level.capzones[var_2].trigger maps\mp\_entityheadicons::setheadicon( level.teamflags[var_1].carrier, level.iconwaitforflag2d, ( 0, 0, 85 ), undefined, undefined, undefined, undefined, undefined, undefined, undefined, 0 );
        }
...
ondrop( var_0 )
{
    ...
    level.enemyflagstatustext[var_2].glowcolor = ( 1, 1, 1 );
    level.enemyflagstatustext[var_2].glowalpha = 0;
    level.capzones[var_2].trigger maps\mp\_entityheadicons::setheadicon( "none", "", ( 0, 0, 0 ) );
...
onreset()
{
    ...
    level.capzones[var_0].trigger maps\mp\_entityheadicons::setheadicon( "none", "", ( 0, 0, 0 ) );
}
