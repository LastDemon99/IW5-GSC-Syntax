...
givejuggloadout( var_0 )
{
    ...
    if ( level.matchrules_showjuggworldicon )
        self.jugg_headicon = maps\mp\_entityheadicons::setheadicon( level.otherteam[self.team], "waypoint_kill", ( 0, 0, 85 ), 24, 24, undefined, undefined, undefined, 1, undefined, 0 );
