...
sabotage()
{
    ...
    level.sabbomb = maps\mp\gametypes\_gameobjects::createcarryobject( "neutral", var_0, var_1, ( 0, 0, 32 ) );
...
createbombzone( var_0, var_1 )
{
    ...
    var_3 = maps\mp\gametypes\_gameobjects::createuseobject( var_0, var_1, var_2, ( 0, 0, 64 ) );
    var_3 resetbombsite();
    var_3.onuse = ::onuse;
...
bombplanted( var_0, var_1 )
{
    ...
    var_6 = spawnfx( level._effect["bombexplosion"], var_4 + ( 0, 0, 50 ), ( 0, 0, 1 ), ( cos( var_5 ), sin( var_5 ), 0 ) );
    triggerfx( var_6 );
