...
bombplanted( var_0, var_1 )
{
    ...
    var_4 = var_0.bombdefusetrig;
    var_4.origin = level.sdbombmodel.origin;
    var_5 = [];
    var_6 = maps\mp\gametypes\_gameobjects::createuseobject( game["defenders"], var_4, var_5, ( 0, 0, 32 ) );
    var_6 maps\mp\gametypes\_gameobjects::allowuse( "friendly" );
    var_6 maps\mp\gametypes\_gameobjects::setusetime( level.defusetime );
    var_6 maps\mp\gametypes\_gameobjects::setusetext( &"MP_DEFUSING_EXPLOSIVE" );
    var_6 maps\mp\gametypes\_gameobjects::setusehinttext( &"PLATFORM_HOLD_TO_DEFUSE_EXPLOSIVES" );
    var_6 maps\mp\gametypes\_gameobjects::setvisibleteam( "any" );
    var_6 maps\mp\gametypes\_gameobjects::set2dicon( "friendly", "waypoint_defuse" + var_3 );
    var_6 maps\mp\gametypes\_gameobjects::set2dicon( "enemy", "waypoint_defend" + var_3 );
    var_6 maps\mp\gametypes\_gameobjects::set3dicon( "friendly", "waypoint_defuse" + var_3 );
    var_6 maps\mp\gametypes\_gameobjects::set3dicon( "enemy", "waypoint_defend" + var_3 );
    var_6.label = var_3;
    var_6.onbeginuse = ::onbeginuse;
    var_6.onenduse = ::onenduse;
    var_6.onuse = ::onusedefuseobject;
    var_6.useweapon = "briefcase_bomb_defuse_mp";
    bombtimerwait();
    ...
    var_7 = level.sdbombmodel.origin;
    level.sdbombmodel hide();

    if ( isdefined( var_1 ) )
    {
        var_0.visuals[0] radiusdamage( var_7, 512, 200, 20, var_1, "MOD_EXPLOSIVE", "bomb_site_mp" );
        ...
        var_0.visuals[0] radiusdamage( var_7, 512, 200, 20, undefined, "MOD_EXPLOSIVE", "bomb_site_mp" );

    var_8 = randomfloat( 360 );
    var_9 = spawnfx( level._effect["bombexplosion"], var_7 + ( 0, 0, 50 ), ( 0, 0, 1 ), ( cos( var_8 ), sin( var_8 ), 0 ) );
    triggerfx( var_9 );
    playrumbleonposition( "grenade_rumble", var_7 );
    earthquake( 0.75, 2.0, var_7, 2000 );
    thread maps\mp\_utility::playsoundinspace( "exp_suitcase_bomb_main", var_7 );
    ...
    var_6 maps\mp\gametypes\_gameobjects::disableobject();
    setgameendtime( 0 );
    wait 3;
