...
onnormaldeath( var_0, var_1, var_2 )
{
    ...
    else if ( !isdefined( level.gameflag ) && cancreateflagatvictimorigin( var_0 ) )
    {
        ...
        var_3 = var_3 + maps\mp\gametypes\_rank::getscoreinfovalue( "firstblood" );
...
ondrop( var_0 )
{
    if ( isdefined( var_0 ) && isdefined( var_0.tdef_flagtime ) )
    {
...
createflag( var_0 )
{
    ...
    var_3 = maps\mp\gametypes\_gameobjects::createcarryobject( "neutral", var_2, var_1, ( 0, 0, 85 ) );
