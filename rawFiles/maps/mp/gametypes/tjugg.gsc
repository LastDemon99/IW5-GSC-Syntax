...
{
    if ( var_3 == "MOD_SUICIDE" && var_4 == "none" && isdefined( self.wasswitchingteamsforonplayerkilled ) )
        return;
    ...
    if ( isdefined( var_1 ) && isplayer( var_1 ) )
    {
        ...
        {
            var_17 = var_17 + maps\mp\gametypes\_rank::getscoreinfovalue( "kill" );
        ...
        {
            var_1.jugg_alligience = var_1.jugg_alligience + 50;

            if ( var_14 )
                var_1.jugg_alligience = var_1.jugg_alligience + 100;
        ...
        {
            var_17 = var_17 + maps\mp\gametypes\_rank::getscoreinfovalue( "jugg_on_jugg" );
        ...
        {
            var_17 = var_17 + maps\mp\gametypes\_rank::getscoreinfovalue( "kill_as_juggernaut" );
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in level.players )
        {
            if ( maps\mp\_utility::isreallyalive( var_1 ) && !var_1 maps\mp\_utility::isusingremote() && var_1 != self && var_1.team == self.team && distancesquared( var_1.origin, self.origin ) < 48400 )
                var_1.jugg_alligience = var_1.jugg_alligience + 25;
        }
    }
}
