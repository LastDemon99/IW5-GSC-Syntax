...
setcarryingremoteuav( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.nukeincoming ) || maps\mp\_utility::isemped() || exceededmaxremoteuavs( self.team ) || maps\mp\_utility::currentactivevehiclecount() >= maps\mp\_utility::maxvehiclesallowed() || level.fauxvehiclecount >= maps\mp\_utility::maxvehiclesallowed() )
        {
...
startremoteuav( var_0, var_1, var_2, var_3 )
{
    ...
    if ( exceededmaxremoteuavs( self.team ) || maps\mp\_utility::currentactivevehiclecount() >= maps\mp\_utility::maxvehiclesallowed() || level.fauxvehiclecount >= maps\mp\_utility::maxvehiclesallowed() )
    {
        self iprintlnbold( &"MP_TOO_MANY_VEHICLES" );
        self notify( "remoteuav_unlock" );
        self takeweapon( "uav_remote_mp" );
