...
export var common_scripts_utility_defs = new Array<CompletionItem>();
var tmpDef;
...
tmpDef.documentation = "Returns a point projected off a tag.";tmpDef.kind = CompletionItemKind.Function;
common_scripts_utility_defs.push(tmpDef);

tmpDef = new CompletionItem("ter_op");
tmpDef.detail = "ter_op( <statement>: boolean, <true_value>: any, <false_value>: any ): any";
tmpDef.documentation = "Function that serves as a tertiary operator in C/C++.";tmpDef.kind = CompletionItemKind.Function;
common_scripts_utility_defs.push(tmpDef);
